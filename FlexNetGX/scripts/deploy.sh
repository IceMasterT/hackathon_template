...
zip -j rust.zip ./target/x86_64-unknown-linux-musl/release/bootstrap ../gx-blockchain/target/wasm32-wasip1/release/flexnet_gx_blockchain.wasm
...
echo "You have successfully created a zip file application. Find it in gx-lambda"
cd ..